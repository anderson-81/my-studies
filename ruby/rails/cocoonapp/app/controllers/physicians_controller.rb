class PhysiciansController < ApplicationController
  ...
  private
    ...
    def physician_params
      ...
      # Modifiquei para receber atributos aninhados numa tela:
      params.require(:physician).permit(
        :name, 
        :appointments_attributes => [:id, :appointment_date, :physician_id, :patient_id, :_destroy,
        :patient_attributes => [:id, :name]
      ])
    end
end
