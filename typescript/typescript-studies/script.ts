...
/*
    ...
    A sintaxe de tipo para declarar uma variável no TypeScript é incluir dois pontos (:) 
    após o nome da variável, seguido por seu tipo.
*/
...
/*
    TypeScript - Loops
        Você pode encontrar situações, quando um bloco de código precisa ser executado várias vezes. 
        Em geral, as instruções são executadas seqüencialmente: 
        a primeira instrução em uma função é executada primeiro, seguida pela 
...
function Example10(){
    ...
    for(var cont:number = 0; cont < 10; cont++){
        console.log(cont);
    }
}
...
function Example16(_name:string, _age?:number, _salary:number = 4321.11){
...
function Example17(_name){
    console.log("Hello, " + _name + "!");
}

function Example18(...nums:number[]):number{
    var sum : number = 0;
...
var Example19 = function(){
    console.log("Anonymous function.");
};

var Example20 = function(num1,num2){
    console.log(num1+num2);
};
...
Example16("Anderson");
Example17("Anderson");
console.log(Example18(10,20,30,40,50,60,70,80,90,0));
Example19();
Example20(30,6);
Example21();
Example22();
